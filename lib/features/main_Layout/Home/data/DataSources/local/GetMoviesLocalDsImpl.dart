...
@Injectable(as: GetMoviesLocalDs)
class GetMoviesLocalDsImpl implements GetMoviesLocalDs {
  static String _boxName(String genre, int page) =>
      'movies_${genre.toLowerCase()}_page$page';

  static const String _metaBoxName = 'movies_meta';
